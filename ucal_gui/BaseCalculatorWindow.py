...
class BaseCalculatorWindow ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Unit Calculator", pos = wx.DefaultPosition, size = wx.Size( 475,494 ), style = wx.DEFAULT_FRAME_STYLE|wx.CLIP_CHILDREN|wx.NO_FULL_REPAINT_ON_RESIZE|wx.TAB_TRAVERSAL )
		...
		self.m_staticText1 = wx.StaticText( self.panel_description, wx.ID_ANY, u"Unit Calculator performs calculations taking into account units.\nEnter \"help\" for general help and \"units\" for a list of defined units.", wx.DefaultPosition, wx.DefaultSize, wx.ST_ELLIPSIZE_END )
		...
		self.text_ctrl_input = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0|wx.WANTS_CHARS )
		self.text_ctrl_input.SetFont( wx.Font( 12, wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Consolas" ) )
		...
		self.panel_options = wx.Panel( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		sbSizer1 = wx.StaticBoxSizer( wx.StaticBox( self.panel_options, wx.ID_ANY, u"Options" ), wx.VERTICAL )

		self.checkbox_remember_window_position = wx.CheckBox( sbSizer1.GetStaticBox(), wx.ID_ANY, u"Save window size and position", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.checkbox_remember_window_position.SetValue(True)
		sbSizer1.Add( self.checkbox_remember_window_position, 0, wx.ALL, 5 )

		self.checkbox_save_history = wx.CheckBox( sbSizer1.GetStaticBox(), wx.ID_ANY, u"Save history between sessions", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.checkbox_save_history.SetValue(True)
		sbSizer1.Add( self.checkbox_save_history, 0, wx.ALL, 5 )

		bSizer9 = wx.BoxSizer( wx.HORIZONTAL )

		self.m_staticText21 = wx.StaticText( sbSizer1.GetStaticBox(), wx.ID_ANY, u"Limit history to", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText21.Wrap( -1 )

		bSizer9.Add( self.m_staticText21, 0, wx.ALL, 5 )

		self.spin_ctrl_history_capacity = wx.SpinCtrl( sbSizer1.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 10000, 1000 )
		bSizer9.Add( self.spin_ctrl_history_capacity, 0, wx.ALL, 5 )

		self.m_staticText22 = wx.StaticText( sbSizer1.GetStaticBox(), wx.ID_ANY, u"entries.", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.checkbox_hide_menu_bar = wx.CheckBox( sbSizer1.GetStaticBox(), wx.ID_ANY, u"Hide menu bar until Alt is pressed", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.button_hide_options = wx.Button( sbSizer1.GetStaticBox(), wx.ID_ANY, u"Hide options", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.menu_file_clear = wx.MenuItem( self.menu_file, wx.ID_ANY, u"&Clear", wx.EmptyString, wx.ITEM_NORMAL )
		self.menu_file.Append( self.menu_file_clear )

		self.menu_file_view_options = wx.MenuItem( self.menu_file, wx.ID_ANY, u"&View options", wx.EmptyString, wx.ITEM_CHECK )
		self.menu_file.Append( self.menu_file_view_options )

		self.menu_file.AppendSeparator()

		self.menu_file_exit = wx.MenuItem( self.menu_file, wx.ID_EXIT, u"E&xit", wx.EmptyString, wx.ITEM_NORMAL )
		...
		self.Bind( wx.EVT_ACTIVATE_APP, self.event_activate_app )
		self.Bind( wx.EVT_CLOSE, self.event_close )
		self.Bind( wx.EVT_ICONIZE, self.event_iconize )
		self.Bind( wx.EVT_SHOW, self.event_show )
		...
		self.button_hide_options.Bind( wx.EVT_BUTTON, self.event_button_hide_options_click )
		self.button_calculate.Bind( wx.EVT_BUTTON, self.event_button_calculate_click )
		self.Bind( wx.EVT_MENU, self.event_menu_file_clear_selected, id = self.menu_file_clear.GetId() )
		self.Bind( wx.EVT_MENU, self.event_menu_file_view_options_selected, id = self.menu_file_view_options.GetId() )
		self.Bind( wx.EVT_MENU, self.event_menu_file_exit_selected, id = self.menu_file_exit.GetId() )
